<template>
  <v-app>
    <v-container fluid fill-height style="background-color: #222e50">
      <v-row justify="center">
        <v-col cols="10" sm="5">
          <v-card fill-height align="center"
              justify="center">
            <v-row
              align="center"
              justify="center"
                      ...
                      <template v-slot:activator="{ on, attrs }">
                        <v-text-field
                          ...
                          :rules="[
                            ...
                            (v) =>
                              isAdult(v) || 'You must be at least 18 years old',
                          ]"
                        ></v-text-field>
                      </template>
                      <v-date-picker
              ...
              <v-col cols="10" sm="7">
                <v-form>
                  <v-text-field
                    ...
                    outlined
                    :rules="[
                      (v) => !!v || 'Credit card expiration date is required',
                    ]"
                  ></v-text-field>
                </v-form>
              </v-col>
                ...
                <v-form>
                  <v-text-field
                    ...
                    :rules="[
                      ...
                      (v) =>
                        /^\d+$/.test(v) ||
                        'Credit card CVV must contain only numbers',
                    ]"
                  ></v-text-field>
                </v-form>
              </v-col>
